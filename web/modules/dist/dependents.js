...
})()(
    {
        ...
        5: [
            function (e, t, a) {
                "use strict";
                var l = e("./lib");
                window.EmployeeDependentAdapter = l.EmployeeDependentAdapter;
            },
            { "./lib": 6 },
        ],
        6: [
            function (e, t, a) {
                        ...
                        i(t, [
                            {
                                key: "getDataMapping",
                                value: function () {
                                    return ["id", "name", "gender","relationship", "dob"];
                                },
                            },
                            {
                                key: "getHeaders",
                                value: function () {
                                    return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Name" }, { sTitle: "Gender" },{ sTitle: "Relationship" }, { sTitle: "Date of Birth" }];
                                },
                            },
                            {
                                key: "getFormFields",
                                value: function () {
                                    return [
                                        ...
                                        ["gender", { label: "Gender", type: "select", source: [
                                            ["M", "Male"],
                                            ["F", "Female"],
                                          ], validation: "" }],
                                          ["dob", { label: "Date of Birth", type: "date", validation: "" }],
                                        ["place_of_birth", { label: "Place of Birth", type: "text", validation: "none" }],                                   
                                        [
                                            "relationship",
                                            {
                                                label: "Relationship",
                ...
                t.exports = { EmployeeDependentAdapter: s };
            },
            { "../../../api/AdapterBase": 2 },
        ],
    },
