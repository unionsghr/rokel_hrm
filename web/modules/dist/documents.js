...
})()(
    {
        ...
        7: [
            function (e, t, a) {
                        ...
                        return (
                            ...
                            l(t, [
                                ...
                                },
                                {
                                    key: "getHeaders",
                                    value: function () {
                                        return [{ sTitle: "ID", bVisible: !1 }, { sTitle: "Document" }, { sTitle: "Details" }, { sTitle: "Date of Issue" }, { sTitle: "Status" }, { sTitle: "Attachment", bVisible: !1 }];
                                    },
                                },
                                {
                                    key: "getFormFields",
                                    value: function () {
                                        return [
                                            ...
                                            ["date_added", { label: "Date of Issue", type: "date", validation: "" }],
                                            ["place_of_issue", { label: "Place of Issue", type: "date", validation: "none" }],
                                            ["valid_until", { label: "Expiry Date", type: "date", validation: "none" }],                                            
                                    ...
                                    value: function (e, t) {
                                        ...
                                        return (
                                            ...
                                            (a = (a = (a = (a = this.showEdit
                                                ? a.replace("_edit_", '<img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"></img>')
                                                : a.replace("_edit_", "")).replace(/_id_/g, e)).replace(/_attachment_/g, t[5])).replace(/_BASE_/g, this.baseUrl))
                                        );
                                    },
                                },
                            ]),
                        ...
                        return (
                            ...
                            l(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        return (
                                            (e.color = this.getColorByFileType(e.type)),
                                            (e.icon = this.getIconByFileType(e.type)),
                                            (e.details_long = this.nl2br(e.details)),
                                            e.details.length > 30 && (e.details = e.details.substring(0, 30)),
                                            (void 0 !== e.size && null != e.size) || (e.size = ""),
                                            e
                                        );
                                    },
                                },
                ...
                t.exports = { EmployeeDocumentAdapter: c, EmployeeCompanyDocumentAdapter: d };
            },
