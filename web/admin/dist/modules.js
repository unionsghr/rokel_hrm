! function () {
  ...
  1: [function (e, t, a) {
    "use strict";
    var l = e("./lib");
    window.ModuleAdapter = l.ModuleAdapter, window.UsageAdapter = l.UsageAdapter
  }, {
    "./lib": 2
  }],
  2: [function (e, t, a) {
    ...
    var c = function (e) {
      ...
      return u(t, n.default), i(t, [{
        key: "getDataMapping",
        value: function () {
          return ["id", "label", "menu", "mod_group", "mod_order", "status", "version", "update_path"]
        }
      }, {
        key: "getHeaders",
        value: function () {
        ...
        value: function (e, t) {
          var a = {
            "admin_Company Structure": 1,
            admin_Employees: 1,
            "admin_Job Details Setup": 1,
            admin_Leaves: 1,
            "admin_Manage Modules": 1,
            admin_Projects: 1,
            admin_Qualifications: 1,
            admin_Settings: 1,
            admin_Users: 1,
            admin_Upgrade: 1,
            admin_Dashboard: 1,
            "user_Basic Information": 1,
            user_Dashboard: 1
          };
          if (1 === a[t[3] + "_" + t[1]]) return "";
          var l = '<div style="width:80px;"><img class="tableActionButton" src="_BASE_images/edit.png" style="cursor:pointer;" rel="tooltip" title="Edit" onclick="modJs.edit(_id_);return false;"/></div>';
      ...
      d = function (e) {
        ...
        return u(t, n.default), i(t, [{
          ...
          value: function () {
            var e = {},
              t = [];
            if ($(".module-check").each(function () {
              $(this).is(":checked") && t.push($(this).val())
            }), 0 !== t.length) {
              e.groups = t.join(",");
              var a = JSON.stringify(e),
                l = [];
              l.callBackData = [], l.callBackSuccess = "getInitDataSuccessCallBack", l.callBackFail = "getInitDataFailCallBack", this.customAction("saveUsage", "admin=modules", a, l)
            } else alert("Please select one or more module groups")
          }
        }, {
          key: "saveUsageSuccessCallBack",
          value: function (e) { }
        }, {
          key: "saveUsageFailCallBack",
          value: function (e) { }
        }]), t
      }();
    t.exports = {
