                  ...
                  value: function () {
                    return [
                      ...
                      [
                        "relation_to_dependent",
                        {
                          label: "Who is the dependent to you?",
                          type: "text",
                          validation: "",
                        },
                      ],
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      ...
                      // },
                      {
                        sTitle: "Off Work Start Date",
                      },
                      {
                        sTitle: "Off Work End Date",
                      },
                      // {
                      //   sTitle: "Status",
                      // },
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      ...
                      {
                        sTitle: "Medical Limit",
                      },
                      {
                        sTitle: "Amount Utilized",
                      },
                      {
                        sTitle: "Limit Balance",
                      }
                      // {
                      //   sTitle: "Off Work End Date",
                      // },
            ...
            i(e, [
                  ...
                  $.ajax({
                    ...
                    success: function (data, textStatus, jQxhr) {
                      ...
                      if (data.responseCode == "000") {
                        ...
                        <tr>
                            <th>Relationship</th>
                            <td>${medical_summary.relationship}</td>
                        </tr>                        
                        <tr>
                            <th>Date of Birth</th>
                            <td>${medical_summary.dob}</td>
                        </tr>
                        <tr>
                            <th>Admission Date</th>
                            <td>${medical_summary.from_date}</td>                            
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  let id_ = e;
                  $.ajax({
                    url: "../../../../rokel_hrm/core/submitStaffMedical.php",
                    type: "post",
                    contentType: "application/json",
                    dataType: "json",
                    async: false,
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  let id_ = e;
                  $.ajax({
                    url: "../../../../rokel_hrm/core/submitDependentMedical.php",
                    type: "post",
                    contentType: "application/json",
                    dataType: "json",
                    async: false,
                  ...
                  $.ajax({
                    ...
                    success: function (data, textStatus, jQxhr) {
                      ...
                      if (data.responseCode == "000") {
                        ...
                        <tr>
                            <th>Grade</th>
                            <td>${medical_summary.grade}</td>
                        </tr>
                        <tr>
                            <th>Amount (SLL)</th>
                            <td>${medical_summary.amount}</td>
                        </tr>
                        <tr>
                            <th>Start Date</th>
